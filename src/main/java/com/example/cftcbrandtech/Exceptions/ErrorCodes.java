...
public enum ErrorCodes {
    ...
    PROPERTY_COULD_NOT_BE_DELETED(8001, HttpStatus.BAD_REQUEST, "PROPERTY COULD NOT BE DELETED"),

    // RESERVATION
    RESERVATION_COULD_NOT_BE_CREATED(9101, HttpStatus.BAD_REQUEST, "Resevertion COULD NOT BE CREATED");
